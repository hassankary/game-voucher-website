      ...
      <div className="container flex flex-col mx-auto px-4 py-12 space-y-5 xl:max-w-7xl justify-center items-center">
        ...
        <div className="flex flex-col w-full gap-y-2">
          ...
          <input
            ...
            className=" max-w-[576px] px-3 py-2 placeholder-white text-xs text-white bg-[#535353] rounded-lg"
          />
        </div>
        <div className="w-full flex justify-start font-medium text-sm">
          <button className="flex items-center gap-2 pl-3 pr-4 py-2 bg-[#0563FC] hover:bg-[#0563FC]/75 active:scale-95 rounded-lg transition-all duration-300 ">
